    ...
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #dddddd; border-radius: 10px; background-color: #f9f9f9;">
        <header style="text-align: center; margin-bottom: 30px;">
          <img src="/AlertGroup.png" alt="Your Company Logo" style="width: 100px;"/>
          <h2 style="color: #333333;">Welcome to AlertGroup</h2>
        </header>
        ...
        <section>
          ...
          <p style="font-size: 16px; color: #555555;">
            Hello, <br/>
            Thank you for signing up at AlertGroup! To complete your registration, please verify your email address by clicking the button below:
          </p>
        ...
        <footer style="margin-top: 30px; text-align: center; font-size: 12px; color: #999999;">
          <p>&copy; ${new Date().getFullYear()} AlertGroup. All rights reserved.</p>
